...
console.log(chalk.blue.bold(   WELCOME TO KINGVON MD   ${chalk.yellow.bold(
VERSION : 1.0. )}   ${chalk.magenta.bold(
MODE BRUTAL)}   ${chalk.green.bold("📃 Information :")}      ${chalk.red.bold(
▢ Script : KINGVON MD
▢ Author : KINGVON
▢ Versi : 1.0
